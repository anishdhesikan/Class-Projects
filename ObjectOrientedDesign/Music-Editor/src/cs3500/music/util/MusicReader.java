      ...
      switch (lineType) {
        ...
        case "basicRepeat":
          try {
            int startBeat = scanner.nextInt();
            int endBeat = scanner.nextInt();
            piece.addBasicRepeat(startBeat, endBeat);
          } catch (NoSuchElementException e) {
            throw new IllegalArgumentException("Malformed basicRepeat line: " + scanner.nextLine
                    ());
          }
          break;
        case "altEnd":
          try {
            int beatToRepeatTo = scanner.nextInt();
            int startBeat = scanner.nextInt();
            int endBeat = scanner.nextInt();
            piece.addAltEnd(beatToRepeatTo, startBeat, endBeat);
          } catch (NoSuchElementException e) {
            throw new IllegalArgumentException("Malformed altEnd line: " + scanner.nextLine
                    ());
          }
          break;
        default:
